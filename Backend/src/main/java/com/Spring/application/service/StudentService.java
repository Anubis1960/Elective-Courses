...
public interface StudentService {
    ...
    void export(OutputStream out, Optional<String> facultySection, Optional<Integer> year, int bitOptions, String extension) throws IOException, IllegalAccessException, InvocationTargetException, NoSuchMethodException;
}
